...
export default class HomeScreen extends React.Component{
  ...
  componentDidMount = async() => {
    ...
    var class_ref =await db.ref('class').on('value', data => {
      ...
      //ELIGE LA OPCIÓN CORRECTA PARA LEER LA INFORMACIÓN DE LA BASE DE DATOS
  ...
  updateAttendence=(roll_no, status)=> {
    ...
    today = dd + '-' + mm + '-' + yyyy;
    //ELIGE LA OPCIÓN CORRECTA PARA ACTUALIZAR EL ESTADO (PRESENTE / AUSENTE EN LA BASE DE DATOS)
